    ...
    <div className="w-full mt-0 pt-0">
      ...
      <section className="bg-white dark:bg-gray-900 py-16 px-6 transition-colors duration-500">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-4xl font-bold text-purple-600 mb-4 dark:text-purple-300">
      ...
      {/* Medios de contacto */}
      <section className="bg-white mb-16 py-0 px-8 dark:bg-gray-900 px-6 transition-colors duration-500">
        <h2 className="text-4xl font-bold text-center mb-10 text-purple-600 dark:text-purple-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-purple-100 transition-transform duration-300 hover:-translate-y-2 dark:bg-gray-800">
            ...
            <h3 className="text-xl font-semibold mb-2 text-pink-500 dark:text-pink-300">Correo Electrónico</h3>
            <p className="text-gray-700 mb-2 dark:text-white">
              <strong>fitlive@gmail.com</strong>
            </p>
            <p>
              ¿Tienes dudas, sugerencias o necesitas ayuda para comenzar? Escríbenos y nuestro equipo responderá en menos de 24 horas. Queremos apoyarte en tu camino hacia una vida sana y sostenible, ofreciéndote orientación rápida y confiable en cada paso que des con FitLive.
            </p>
          </div>

          <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-purple-100 transition-transform duration-300 hover:-translate-y-2 dark:bg-gray-800">
            <span className="text-4xl mb-4">📱</span>
            <h3 className="text-xl font-semibold mb-2 text-pink-500 dark:text-pink-300">Asesoría personalizada</h3>
            <p className="text-gray-700 mb-2 dark:text-white">
          ...
          <div className="flex flex-col items-center text-center p-6 shadow-md rounded-lg bg-purple-100 transition-transform duration-300 hover:-translate-y-2 dark:bg-gray-800">
            <span className="text-4xl mb-4">📍</span>
            <h3 className="text-xl font-semibold mb-2 text-pink-500 dark:text-pink-300">Redes sociales</h3>
            <p className="text-gray-700 dark:text-white"><strong>Instagram:</strong></p>
            <p>@fitlife.oficial</p>
            <p className="text-gray-700 dark:text-white"><strong>Twitter:</strong></p>
            <p>@FitLife</p>
            <p className="text-gray-700 dark:text-white"><strong>TikTok:</strong></p>
            <p>@FitLife.18</p>
            <p className="mt-2">Síguenos para tips diarios de ejercicios y recetas.</p>
          </div>
        </div>
      </section>

       {/* Preguntas Frecuentes */}
      <section className="text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-12 transition-colors duration-500">
        <h2 className="text-4xl text-purple-600 font-bold text-center mb-12 dark:text-purple-300">
          Preguntas Frecuentes
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="bg-pink-200 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">🌿 ¿Qué es FitLive?</h3>
          ...
          <div className="bg-pink-300 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">❤️ ¿Tiene algún costo?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          {/* Tarjeta 3 */}
          <div className="bg-pink-200 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">📱 ¿Puedo usarlo desde mi celular?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          {/* Tarjeta 4 */}
          <div className="bg-pink-300 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">⭐ ¿Necesito experiencia previa?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          {/* Tarjeta 5 */}
          <div className="bg-pink-200 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">⏳ ¿Cuánto tiempo tomarán los resultados?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          {/* Tarjeta 6 */}
          <div className="bg-pink-300 dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform duration-300 hover:-translate-y-2">
            <h3 className="text-lg text-black-600 dark:text-white font-semibold mb-2">🥗 ¿Los planes de alimentación son personalizados?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
      ...
      <section className="py-16 px-8">
        <h2 className="text-4xl font-bold text-center mb-7 text-purple-500 dark:text-purple-300">
        ...
        >
          <div>
            <label className="block font-medium text-purple-500 mb-1 dark:text-purple-300">Nombre completo</label>
            <input
              type="text"
              name="username"
              value={formData.username}
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring focus:ring-sky-300 dark:bg-gray-600 border-gray-500"
          ...
          <div>
            <label className="block font-medium text-purple-500 mb-1 dark:text-purple-300">Teléfono</label>
            <input
              type="text"
              name="phoneNum"
          ...
          <div>
            <label className="block font-medium text-purple-500 mb-1 dark:text-purple-300">Correo electrónico</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="block font-medium text-purple-500 mb-1 dark:text-purple-300">Mensaje</label>
            <textarea
              name="message"
              value={formData.message}
              onChange={handleChange}
              rows="4"
              className="w-full border border-gray-50 rounded-md p-2 focus:outline-none focus:ring focus:ring-sky-300 dark:bg-gray-600 border-gray-500"
          ...
          <div>
            <label className="block font-medium text-purple-500 mb-2 dark:text-purple-300">
